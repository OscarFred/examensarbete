...
export default {
  ...
  methods: {
    ...
    logIn: function() {
      window.location.href = "https://api.tjeckbox.com:8080/auth/google";
    },
    logOut: function() {
      window.location.href = "https://api.tjeckbox.com:8080/auth/logout";
    },
    checkIfLoggedIn() {
      axios
        .get("https://api.tjeckbox.com:8080/auth/check", {
